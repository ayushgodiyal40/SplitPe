...
typedef KiranaPreset = ShopBillPreset;
...
class PosCheckoutViewState extends State<PosCheckoutView> {
  final _amountController = TextEditingController(text: ShopConfig.defaultAmount);
  final _vpaController = TextEditingController(text: ShopConfig.merchantVpa);
  final _nameController = TextEditingController(text: ShopConfig.shopName);

  SplitOrder? _currentOrder;
  String? _soundboxAnnouncement;
  String _selectedPresetTitle = 'CUSTOM BILL';

  static List<ShopBillPreset> get _kiranaPresets => ShopConfig.billPresets;
            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'e.g. ${ShopConfig.merchantVpa}',
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'e.g. ${ShopConfig.shopName}',
                    hintStyle: const TextStyle(
                      color: AppColors.textMuted,
                      fontSize: 13,
                    ),
              ...
              // Restore Shop Default Button
              InkWell(
                onTap: () {
                  tempVpaController.text = ShopConfig.merchantVpa;
                  tempNameController.text = ShopConfig.shopName;
                  setModalState(() {});
                },
                child: Container(
                  padding: const EdgeInsets.symmetric(vertical: 10),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        'RESTORE SHOP DEFAULT (${ShopConfig.shopName.toUpperCase()})',
                        style: const TextStyle(
                          fontSize: 10,
                          fontWeight: FontWeight.w900,
                          letterSpacing: 0.8,
  ...
  void _openCheckoutDialog() {
    if (_vpaController.text.trim().isEmpty) {
      _vpaController.text = ShopConfig.merchantVpa;
      _nameController.text = ShopConfig.shopName;
    }
